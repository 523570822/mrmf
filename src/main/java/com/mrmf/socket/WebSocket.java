...
public class WebSocket {
 ...
 //   public static CopyOnWriteArraySet<WebSocket> webSocketSet = new CopyOnWriteArraySet<WebSocket>();
    public static Map<String,WebSocket> webSocketSet=new HashMap<String,WebSocket>();
    ...
    public void onOpen(Session session,@PathParam("userId")String  userId){
     ...
     //   ConsumerKafka consumerKafka = new ConsumerKafka(session);
      //  consumerKafka.start();
    }
    ...
    public void onClose(){
        ...
        webSocketSet.remove(map.get("userId"));  //从set中删除
