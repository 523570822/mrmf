...
public @interface MRequestParam {
	 ...
	 * <p>
	 * Default is {@code false}, leading to an exception thrown in case of the
	 * parameter missing in the request. Switch this to {@code false} if you
	 * prefer a {@code null} in case of the parameter missing.
	 * <p>
	 * Alternatively, provide a {@link #defaultValue() defaultValue}, which
	 * implicitly sets this flag to {@code false}.
	 */
