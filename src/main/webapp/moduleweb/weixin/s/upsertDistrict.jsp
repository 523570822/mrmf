			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>
							<a
								href="${ctxPath}/weixin/s/toQuery.do?type=2&cityId=${ffdistrict.cityId}"
								class="btn-link"> <i class="fa fa-angle-double-left"></i>返回
							</a>
							<c:if test="${ffdistrict._id == null}">
								新建区域
							</c:if>
							<c:if test="${ffdistrict._id != null}">修改区域
							</c:if>
						</h5>
					</div>
					<div class="ibox-content">
						...
						<form id="district" method="post"
							action="${ctxPath}/weixin/s/upsertDistrict.do"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input id="order" name="order" type="text" class="form-control"
										...
										class="help-block m-b-none">区域显示排序编码，将从小到大排列。</span>
								</div>
							</div>
									...
									.click(
											function() {
												document.location.href = _ctxPath
														+ "/weixin/s/toQuery.do?type=2&cityId=${ffdistrict.cityId}";
											});
