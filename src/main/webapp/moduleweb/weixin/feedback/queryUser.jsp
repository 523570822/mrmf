				 		...
				 		<form id="searchForm" method="get" class="form-horizontal">
							<div class="form-group">
								...
								<div style="width: 250px" class="col-sm-3">
									<input id="gte:createTime|datetime"
										name="gte:createTime|datetime"
										class="laydate-icon form-control" placeholder="开始日期">
								</div>
								<label style="width: 10px" class="col-sm-1 control-label">至</label>
								<div style="width: 250px" class="col-sm-3">
									<input id="lte:createTime|datetime"
										name="lte:createTime|datetime"
						...
						function() {
									...
									.click(
											function() {
												var param = $("#searchForm")
														.formobj();
												var o = {};
												o.userName = param["regex:userName"];
												...
												window.location.href = _ctxPath
														+ "/weixin/sysConfig/exportUserFeed.do?"
														+ parStr;
							...
							$("#feedBackTable")
									.grid(
											{
												url : _ctxPath
														+ "/weixin/sysConfig/queryFeedBacks.do?type="
														+ $("#type").val(),
												shrinkToFit : false,
												colNames : [ "反馈用户姓名",
														"反馈用户电话", "反馈意见",
