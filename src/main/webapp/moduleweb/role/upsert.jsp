			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>
							<a
								href="${ctxPath}/role/toQuery.do?parentId=${param.parentId}&organId=${param.organId}"
					...
					<div class="ibox-content">
						...
						<form id="role" method="post" action="${ctxPath}/role/upsert.do"
							class="form-horizontal">
							<input type="hidden" id="_id" name="_id"><input
								type="hidden" id="parentId" name="parentId"
								value="${param.parentId}"> <input type="hidden"
								id="organId" name="organId" value="${param.organId}">
									...
									.click(
											function() {
												document.location.href = _ctxPath
														+ "/role/toQuery.do?parentId=${param.parentId}&organId=${param.organId}";
											});
