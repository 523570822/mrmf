				...
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						...
						<div class="jqGrid_wrapper">
							<table id="chukushenheTable"></table>
						</div>
					</div>
				</div>
			</div>
												...
												colModel : [
															{
																...
																formatter : function(
																		...
																		options,
																		rowObject) {
																		var v = "<a href='javascript:void(0);'onclick='checkChuku(\""
																			+ cellvalue
																			+ "\")'>审核</a>&nbsp;&nbsp;";
		...
		function removeChuku(chukuId) {
			...
			$.get(url, {}, function(data) {
				if (data) {
					...
					$("#chukushenheTable").trigger("reloadGrid");
				} else {
					toastr.error("操作失败");
				}
			});
		}
		function checkChuku(chukuId) {
			var url = _ctxPath + "/kucun/chuku/check/" + chukuId + ".do";
			$.get(url, {}, function(data) {
				if (data) {
					if (data.success) {
						toastr.success("操作成功");
