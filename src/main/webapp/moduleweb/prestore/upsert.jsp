            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form id="usercard" method="post"
                          action="${ctxPath}/prestore/upsert.do"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="shopPrice" name="shopPrice" type="text"
                                       class="form-control" value="${prestore}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="charge" name="charge" type="number"
                                    ...
                                    class="help-block m-b-none">商城预存款充值金额，负数为冲减，但冲减后余额不能为负数。</span>
                            </div>
                        </div>
