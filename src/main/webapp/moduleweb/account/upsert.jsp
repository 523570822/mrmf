				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<form id="account" method="post"
							action="${ctxPath}/account/upsert.do" class="form-horizontal">
							<input type="hidden" id="_id" name="_id"><input
								type="hidden" id="accountType" name="accountType" value="organ">
							<input type="hidden" id="status" name="status" value="1"><input
								type="hidden" id="entityID" name="entityID"
									...
									.click(
											function() {
												document.location.href = _ctxPath
														+ "/account/toQuery.do?parentId=${param.parentId}&organId=${param.organId}";
											});
