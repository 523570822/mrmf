			...
			<div class="col-sm-12" style="height:100% !important;">
				<div class="ibox float-e-margins" style="height:100% !important;">
					<div class="ibox-content" style="height:100% !important;">
						...
						RRR		<div class="col-sm-3" style="width:20%;">
				...
				.ready(
						function() {
							$('#export').click(function() {
								$("#searchForm").attr("action", _ctxPath + "/finance/redpacket/exportStaffRedPacket.do").submit();
							});
							var start = {
							...
							$("#userWalletTable")
									.grid(
											{
												url : _ctxPath
														+ "/finance/redpacket/queryStaffRedPacket.do",
												height:'94%',
												shrinkToFit : false,
												colNames : [ "技师名称","技师所在店铺名称","发送红包金额",
														"分成的份数","操作时间"],
												postData : $("#searchForm")
														.formobj(),
												colModel : [
