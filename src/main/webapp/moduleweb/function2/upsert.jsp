			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>
							<a
								href="${ctxPath}/function2/toQuery.do?parentId=${param.parentId}"
					...
					<div class="ibox-content">
						...
						<form id="function" method="post"
							action="${ctxPath}/function2/upsert.do" class="form-horizontal">
									...
									.click(
											function() {
												document.location.href = _ctxPath
														+ "/function2/toQuery.do?parentId=${param.parentId}";
											});
