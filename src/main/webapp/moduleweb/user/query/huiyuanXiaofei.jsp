                        ...
                        <input type="hidden" id="sortField" name="sortField"
                               value="createTime"> <input type="hidden" id="sortOrder"
                                                          name="sortOrder" value="DESC"> <input type="hidden"
                                                                                                id="in:type|array-integer"
                                                                                                name="in:type|array-integer"
                                                                                                value="1,11">
                        <%--<input type="hidden"--%>
...
//            $("#content").val($("#test").serialize());
            $("#export").submit();

     //       console.log(downloadstr);
    //        alert(JSON.stringify(form));
        });
        $("#gte\\:createTime\\|date").val(new Date().format());
        ...
        $("#multipleSearch").click(function() {
            showMultipleSearch("searchForm", "myTable", "myTable2", "会员号,卡表面号,消费金额,服务明细,会员姓名,电话,员工1,员工2,服务日期,会员类型,服务大类,员工1提成,员工2提成,是否删除,挂账,员工3,员工3提成,使用产品价钱,总次数,剩余次数,免单,员工1业绩,员工2业绩,员工3业绩");
        });
        $("#myTable").grid({
            url: _ctxPath + "/user/userpart/queryByFpi.do",
            postData: $("#searchForm").formobj(),
            shrinkToFit: false,
            ...
            colNames: ["流水号", "会员号", "卡表面号", "挂账", "是否子卡", "消费金额", "余额", "消费次数", "总次数", "剩余次数", "单次款额", "服务明细", "会员姓名", "电话", "备注", "员工1", "员工2", "会员类型", "员工3", "服务日期", "员工1提成", "员工2提成", "是否删除", "员工3提成", "使用产品价钱", "免单", "员工1业绩", "员工2业绩"],
            colModel: [{
                name: "xiaopiao",
                index: "xiaopiao",
                width: 100
