...
<head>
	...
	<body>
		 <div class="common_nav">
	        <i onclick="window.location.href='${ctxPath}/w/userMy/myDonation'"></i>
		...
		<div class="my_info my_info_line">
		 ...
		 <form id="form" action="${ctxPath}/w/userMy/toComPwd" method="post">
			<div class="fill_info">
				<label>转账金额：</label><input id="amount" type="text" name="amount" >
			</div>
			<input type="hidden"  name="walletAmount" id="walletAmount" value="${ walletAmount }" />
