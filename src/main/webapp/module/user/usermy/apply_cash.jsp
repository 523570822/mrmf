...
<body class="bg_gray">
    <div class="common_nav">
        <i onclick="window.location.href='${ctxPath}/w/userMy/myWallet'"></i>
    ...
    <script type="text/javascript">
    	$("#com_cash").click(function() {
	        ...
	        $.post(_ctxPath+"/w/userMy/isPayPassword",{"money":money},function(data) {
	              if(data == 1) { 
	              	 $(".cash_bg").fadeIn("fast");
	              	 $(".m_pwderror").fadeIn("fast");
	              } else if(data ==0) {
	                 window.location.href=_ctxPath+"/w/userMy/inputPwd?money=" + encodeURIComponent(encodeURIComponent(money));
	              } else if(data == 2) {
	              	 alert('钱包余额不足,不能提现！');
	              }else {
