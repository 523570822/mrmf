	 ...
	 <div>
	 	<ul>
	 		...
	 		<li class="detailTitle" style="height: 2.2rem;margin-top:0.7rem;" >
	 			...
	 			<div class="col-2"><span>预约技师</span> </div>
	 			<div class="col-1-1"><img src="${ossImageHost}${order.staffLogo}@!avatar"></div>
	 			<div class="col-2-7" style="padding-left: 0.9rem;"><span>${order.staffName }</span> </div>
