$(function(){
	...
	$('#back').click(function() {
		...
		window.location.href = _ctxPath + '/w/userMy/toUserMyHome?sysMessage=' + sysMessage + '&status=message';
	});
});
			...
			if (obj.data.length==0) {
				...
				for(var i=0;i<obj.data.length;i++){
					html+='<li><div ';
					 ...
					 html+='class="mess">'+obj.data[i].content+'</div><div class="time">'+obj.data[i].createTimeFormat+'</div></li>';
				}
				$("#message_list").html($("#message_list").html()+html);
			}
	  },
