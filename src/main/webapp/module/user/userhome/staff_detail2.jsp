...
<body class="bg_gray">
    <div class="common_nav">
        <i id="staffDetailBack" onclick="staffDetailBack()"></i>
    ...
    <div class="tech_fun">
        <ul>
            <li id="profile">个人简介</li>
            <li id="staffCase"><span>典型案例</span></li>
            <input id="staffId" type="hidden" value="${ staff._id }" />
        </ul>
    </div>
    <div class="hair_list" id="cases">
     </div>
     <div style="float:left;height:3.8rem;width:100%;" class="bg_gray">
	</div>
    <div class="bot_appoint">
     ...
     <script src="${ctxPath}/module/user/userhome/js/des2.js"></script>
