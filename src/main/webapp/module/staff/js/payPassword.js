$(document).ready(function(){
   ...
   $("#back").click(function(){
	   ...
	   if(backFlag == 1) {
		   ...
		   window.location.href = _ctxPath + '/w/staffMy/toLastPage.do?status='+'withdraw';
	   }
   });
   $("#commit").click(function(){
		...
		$.post(_ctxPath + "/w/staffMy/setPayPassword",$("#form").formobj(),
		    function(data){
				if(data.status  == 1) {  //设置成功
				   ...
				   if(backFlag == 1) {
					   ...
					   window.location.href = _ctxPath + '/w/staffMy/withdraw';
				   }
