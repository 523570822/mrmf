...
<input type="hidden" value="${order._id }" id="order_id">
	<div class="nav">
	 	...
	 	<ul>
	 		...
	 		<c:if test="${order.state==10 }">
	 			<li class="detailTitle" style="height: 2.2rem;margin-top:0.35rem; ">
		 			...
		 			<div class="col-1-4">
		 				<c:forEach begin="1" end="${order.starZan}">
		 					<i class="comment"></i>
		 				</c:forEach>
		 			</div>
		 		</li>
	 ...
	 <c:if test="${order.state==1 }">
		 <div class="bottom">
			<button class="button-left font-34" id="refuse">拒绝</button>
			<button class="button-right font-34" id="confirm">确认</button>
		 </div>
	 </c:if>
<script src="${ctxPath}/module/resources/js/media_contrl.js"></script>
<script src="${ctxPath}/module/staff/myMessageOrder/js/messageOrder.js"></script>
</body>
</html>