    ...
    <ul>
        ...
        <form action="" method="post" id="form">
            ...
            <div class="col-8">
            	...
            	<input type="hidden" name="status" value="home" id="status">
                <input type="text" style="width: 95%;" name="val" value="${staff.home }" placeholder="请输入新地址" id="value">
            </div>
        </form>
        </li>
    </ul>
