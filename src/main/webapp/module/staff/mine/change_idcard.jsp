    ...
    <ul>
        ...
        <form action="" method="post" id="form">
            ...
            <div class="col-8">
            	...
            	<input type="hidden" name="status" value="idcard" id="status">
                <input type="text" id="value" name="val" value="${staff.idcard }" placeholder="请输入新身份证号">
            </div>
        </form>
        </li>
    </ul>
