...
<div class="nav">
    ...
    <h4 class="font-34">修改性别</h4>
    <i class="i0 confirm" id="submit">确定</i>
</div>
   <form action="" method="post" id="form">
        <input type="hidden" name="staffId" value="${staff._id }">
        <input type="hidden" name="status" value="sex">
        <input type="hidden" name="val" value="${staff.sex }" id="change_sex">
        <input type="hidden" name="sex" value="${staff.sex }" id="sex">
    <div class="change_box">
    <ul class="sex_select" id="change_sex">
        <li class="active">
            <div class="col-2">男</div>
            <div class="col-8"><i></i></div>
        </li>
        <li>
            <div class="col-2">女</div>
            <div class="col-8"><i></i></div>
        </li>
    </ul>
</div>
