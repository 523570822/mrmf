...
<input type="hidden" id="id" value="${organ._id }"/>
<body class="bg_gray">
    <div class="common_nav">
        <i onclick="window.location.href='${ctxPath}/w/organ/toInputMoney'"></i>
    ...
    <script src="${ctxPath}/module/organ/store/js/inputPwd.js"></script>
  </body>
</html>