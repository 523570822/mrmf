...
<body class="bg_gray">
    ...
    <input id="id" type="hidden" value="${organ._id }">
    <input type="hidden" value="" id="pages"/>
    <input type="hidden" value="" id="page"/>
    <div class="wallet_rule">
        <div class="wallet_fun" style="height: 100%;">
            <div class="cash_div">
                <div>
                ...
                <div class="balance_money">
                    <div>
                        <span>&yen;&nbsp;<i><fmt:formatNumber value ="${organ.walletAmount}" pattern="#0.00"/></i></span>
                    </div>
                </div>
            </div>
     ...
     <script src="${ctxPath}/module/organ/store/js/wallet.js"></script>
</body>
</html>